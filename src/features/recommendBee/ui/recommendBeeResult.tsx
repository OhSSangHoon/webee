...
export default function ResultBox() {
  const { resultData, isSuccess } = useRecommendBee();
  ...
  return (
    <div className="relative flex flex-col justify-center items-stretch w-full h-full card-section">
      ...
      <button className="w-full border rounded border-indigo-600 text-indigo-600 hover:bg-indigo-50 my-5 py-2 transition">
        저장하기
      </button>
    </div>
  );

...
export const ProductCard = memo<ProductCardProps>(({ product, index, formatPrice }) => {
  ...
  return (
    <div className="w-[235px] h-[200px] rounded-md border border-gray-300 flex flex-col hover:shadow-md transition-all duration-300 group">
      {/* 상품 이미지 */}
      ...
      >
        <div className="flex flex-col">
          <div className="text-sm font-semibold mb-1 truncate group-hover:text-blue-600 transition-colors" title={product.name}>
            {product.name}
          </div>

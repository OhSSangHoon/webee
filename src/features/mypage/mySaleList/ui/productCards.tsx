...
export const ProductCard = memo<ProductCardProps>(
  ({ product, index, formatPrice }) => {
    ...
    return (
      ...
      >
        {/* 상품 이미지 영역 */}
        <div className="relative w-full h-[200px] sm:h-[180px] lg:h-[160px] min-h-[160px] overflow-hidden rounded-t-lg bg-gray-100" style={{contain: 'layout style'}}>
          {/* 로딩 상태 - 고정 크기로 layout shift 방지 */}
          {isImageLoading && (
            <div className="absolute inset-0 w-full h-full flex items-center justify-center bg-gray-100" style={{contain: 'layout'}}>
          ...
          {product.imageUrls && product.imageUrls.length > 0 && !imageError ? (
            ...
            <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center bg-gray-50 text-gray-400" style={{contain: 'layout'}}>
        ...
        <div className="p-3 sm:p-4 h-[120px] sm:h-[120px] lg:h-[120px] flex flex-col justify-between" style={{contain: 'layout'}}>
